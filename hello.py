greetings = ["greetings", "hi", "howdy", "welcome", "bonjour", "buenas noches", "buenos dias", "good day",
             "good morning", "hey", "hi-ya", "how are you", "how goes it?", "howdy-do", "shalom", "what's happening?",
             "yo"]

# hello_check = ['$hello Testy', '$hello testy', '$heya', '$hi', '$yo', "$what's up?",
# "$hello", "$on?", "$testy", "$are you there?"]

testy_is_being_bad = ["😢 Sorry, I'll try to do better.", "😢 I'm sorry, I'm not good enough.", "Ouch! That hurts!",
                      "I don't mean to mess up. 😢", "Hey, be nice to me. 😢", "It's Colleen's fault. 😢",
                      "Tell Colleen to fix this.", "I'm sorry, I just a bebe bot", "Be nice to the bebe!",
                      "You're kinda mean to me.", "Hey, not my fault you can't type.", "Oops, I'm sorry.",
                      "Bebe bots make mistakes. 🤷", "I'm not bad, I'm just drawn that way. 😉",
                      "You think that's bad? I wasn't even trying.", "Sorry.", "I'm sorry.", "Let's try again.",
                      "I'm not bad, you're bad.", "Nuh huh, you.", "I know what you are, but what am I?"]

smack_testy_responses = ["OUCH!", "Bot ABUSE!", "You're MEAN!", "Stop it!", "💢😠", "😡"]
